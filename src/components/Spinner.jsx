...
export function TextMorph({ words, interval = 2000, className }) {
...
const WAVE_PATH =
    'M 0 36.5 C 67.43 36.5, 99.09 15.5, 160.53 15.5 C 221.98 15.5, 250.54 36.5, 300 36.5 C 348.56 36.5, 397.30 7, 457.63 7 C 517.96 7, 539.66 36.5, 600 36.5 C 667.43 36.5, 699.09 15.5, 760.53 15.5 C 821.98 15.5, 850.54 36.5, 900 36.5 C 948.56 36.5, 997.30 7, 1057.63 7 C 1117.96 7, 1139.66 36.5, 1200 36.5 L 1200 800 L 0 800 Z';

const LiquidWaveSpinner = memo(({ size = 'md', hideText, className, ...props }) => {
