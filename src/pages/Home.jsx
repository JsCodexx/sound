        ...
        <div>
            ...
            <div className='flex'>
                <div className='relative mt-20 ml-30'>
                    ...
                    <img src="/src/assets/black.png" alt="" width={500} />
                    <img src="/src/assets/pic.png" alt="" className='absolute top-21' width={500} />
                </div>
                <div className='relative mt-20 ml-20'>
                    <h1 className='text-2xl font-bold mb-3'>Find Your Plan</h1>
                    <p className='mb-4'>See what Splice is all about in this short video.</p>
                    <img src="/src/assets/black.png" alt="" width={500} />
                    <img src="/src/assets/square.png" alt="" className='absolute top-21' width={500} />
                </div>
            </div>
