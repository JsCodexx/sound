...
export function Cards() {
    return (
        <Card size="sm" className="p-0 rounded-none w-auto h-60 md:w-[440px] border-[#EBEBEB] border-1 max-w-lg">
            <div className=" bg-[#F5F5F5] h-13 p-3 border-[#EBEBEB] rounded-none gap-45 flex md:gap-60">
