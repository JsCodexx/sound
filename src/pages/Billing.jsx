    ...
    return (
        <div className='bg-transparent'>
            ...
            <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" >
                ...
                <div className=' lg:ml-75  md:ml-0'>
                    <h1 className='text-2xl  mt-5 font-bold' >Payment Method</h1>
                </div>
                <div className='flex flex-col justify-center items-center
                '>
                    <img src="/src/assets/atm.png" alt="" className='mt-20 w-20' />
                    <h1 className='text-center mt-10  text-gray-400 lg:w-90'>Add your payment method for all purchases Made on Company name.</h1>
                    <AlertDialog>
                        <AlertDialogTrigger asChild>
                            <button className='rounded-4xl bg-[#CD4848] text-white  text-center  mt-10 text-sm py-3 px-4 cursor-pointer hover:bg-red-800'>Add Payment Method</button>
                        </AlertDialogTrigger>
                        <AlertDialogContent>
                ...
                <div className=' lg:ml-75  md:ml-0'>
                    <h1 className='text-2xl  mt-9 font-bold' >Transaction History</h1>
                </div>
                <div className='flex flex-col justify-center items-center'>
                    <h1 className='text-center mt-15  text-gray-400 lg:w-90'>Add your payment method for all purchases Made on Company name.</h1>
                    <button className='rounded-4xl mb-15 bg-[#8054F6] text-white text-center  mt-10 text-sm py-3 px-10 cursor-pointer hover:bg-purple-800'>Browse plans</button>
                </div>
            </div>
            <Footer2 />
        </div>
