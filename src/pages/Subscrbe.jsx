    ...
    return (
        <div className=" h-[100vh]" >
            ...
            <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" >
                ...
                <hr />
                <div className='flex flex-col ml-20 md:ml-125 mt-10'>
                ...
                <AlertDialog>
                    <AlertDialogTrigger asChild>
                        <button     >
                            <img src="src/assets/Frame7(1).png" alt="" className='mt-10 md:ml-124 ml-20 cursor-pointer' width={280} />
                        </button>

                    </AlertDialogTrigger>
                    <AlertDialogContent>
                        <img className="ml-25 mb-5" src="/src/assets/msg.png" alt="" width={70} />
