...
function Sound() {
    ...
    return (
        <div className=' '>
            ...
            <main className="w-full max-w-[1440px] mx-auto px-8 relative">
                <div className='w-full'>
                    ...
                    <div className='flex flex-col text-[#5C5C5C] gap-5 absolute top-120 left-60'>
                        ...
                        <div className='w-auto'>
                            ...
                            <div className='flex gap-4 w-full pr-10 h-110'>
                            ...
                            {/* section2 */}
                            <h1 className='ml-50  text-black text-2xl font-bold'>What's New This Week</h1>
                            <p className='w-100 text-center text-sm ml-35 py-0'>
