...
function Sound() {
    ...
    return (
        <div className=' '>
            <NavBar />
            <div className=''>
                <div className='flex ml-30 mt-5 gap-5  w-100% overflow-x-hidden'>
                    <SideBar />
                ...
                <div className='' >
                    <img src="/src/assets/image86.png" alt="" className='absolute top-35 left-60 w-220' />
                    <img src="/src/assets/f1.png" alt="" className='absolute top-35 left-175 w-110' />
                </div>
