...
export default function HoverCards() {
    return (
        <div className='flex md:flex-row flex-col gap-6 mt-12 mb-15 cursor-pointer justify-center items-center'>
            <div className='bg-black hover:bg-[#D74664]  w-67 h-125  rounded-lg transition-all duration-100 ease-in-out hover:-translate-y-2 hover:scale-[1.1]'>
                <div className='text-white  ml-10  pt-7 flex flex-col group gap-5'>
