            ...
            <div className=' '>
                <div className="hidden md:flex min-h-[68px] w-full items-center justify-between px-4 lg:px-8 xl:px-14">
                    ...
                    <div className="flex items-center gap-4 lg:gap-6">
                        ...
                        <Link
                            to="/sound"
                            className="text-sm text-[#B9BABB] font-semibold hover:text-gray-300 transition"
                        >
                            Sounds
                        </Link>
                    ...
                    <div className="flex items-center gap-3 lg:gap-5">
                        ...
                        {variant === 'landing' ? (
                            ...
                            <>
                                <Link
                                    to="/help"
                                    className="text-sm hover:text-gray-300 transition font-semibold"
                                >
                                    Help
                                </Link>

                                <button className="bg-white font-bold text-red-700  text-sm  rounded-full px-4 py-2 hover:bg-gray-200 transition">
                                    TRY FREE
                                </button>
