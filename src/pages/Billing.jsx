    ...
    return (
        <div className={` ${bill ? 'bg-[#000000C9]' : 'bg-transparent'}`}>
            ...
            <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" >
                ...
                <button onClick={openBill} className='rounded-4xl bg-[#CD4848] text-white ml-25 text-center md:ml-135 mt-10 text-sm py-3 px-4 cursor-pointer hover:bg-red-800'>Add Payment Method</button>
