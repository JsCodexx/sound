    ...
    return (
        <>
            <div className='relative container mx-auto max-w-7xl px-4 sm:px-6 lg:px-0'>
                <div className='flex'>
                    <div className='bg-[#000000] md:block hidden  w-213.5 h-screen relative'>
                        ...
                        <div className='w-[139.56px] absolute h-[209.7px] top-[25.45px] left-[225.94px] bg-[#CD4848]'>
                            ...
                            <img src="/src/assets/scratch.png" alt="abc" width={50} className='ml-9 absolute mt-2 top-10 left-15 w-9' />
                        </div>
                        ...
                        <div className='absolute top-35 left-177'>
                            <img src="/src/assets/blue1.png" alt="" />
                        </div>
                        <div className='absolute top-63 left-185'>
                            <img src="/src/assets/blue1.png" alt="" />
                        </div>
                        <div className='absolute top-105 left-185'>
                            <img src="/src/assets/brown.png" alt="" />
                        </div>
                        <div className='absolute top-110 left-195'>
                            <img src="/src/assets/brown.png" alt="" />
                        </div>
                        <div className='absolute top-90 left-45'>
                            <img src="/src/assets/brown.png" alt="" />
                        </div>
                        <div className='absolute top-95 left-0'>
                        ...
                        <div className='absolute top-140 left-58'>
                            ...
                            <h1 className='text-white font-bold text-2xl absolute bottom-8 left-17'>This Content Here Is Dummy</h1>
                            <p className='text-white text-sm  absolute top-10 left-10'>Start for free and get attractive offers from the community</p>
                        </div>
                    </div>
                    <div>
                        ...
                        <div className='flex gap-15 ml-10 mt-5  '>
